...
class SmartComputerPlayer(Player):
    ...
    def minimax(self, state, player):
        ...
        # first step: check whether the previous move was the winner
        ...
        for possible_move in state.available_moves():
            ...
            sim_score['position'] = possible_move               # represents the next optimal move

            if(player == max_player):
                if(sim_score['score'] > best['score']):         # update best score
                    best = sim_score
